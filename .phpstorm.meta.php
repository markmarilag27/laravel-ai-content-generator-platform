...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Contracts\AIProvider' => \App\Services\AI\OpenAIProvider::class,
    ...
    override(\config(), map([
            ...
            'toon.min_rows_for_table' => 'integer',
            'toon.max_flatten_depth' => 'integer',
            'toon.indent' => 'integer',
            'toon.delimiter' => 'string',
            'toon.strict' => 'boolean',
            'toon.key_folding' => 'string',
            'toon.key_folding_depth' => 'NULL',
            'toon.expand_paths' => 'string',
            'toon.omit' => 'array',
            'toon.omit_keys' => 'array',
            'toon.key_aliases' => 'array',
            'toon.date_format' => 'NULL',
            'toon.truncate_strings' => 'NULL',
            'toon.number_precision' => 'NULL',
            'one-time-operations.directory' => 'string',
            'one-time-operations.table' => 'string',
            'one-time-operations.connection' => 'NULL',
...
'mail.from.name','mail.markdown.theme','mail.markdown.paths','openai.api_key','openai.organization',
...
'reverb.apps.apps.0.max_message_size','reverb.apps.apps.0.accept_client_events_from','services.postmark.key','services.resend.key','services.ses.key',
...
'boost.executable_paths.vendor_bin','mcp.redirect_domains','toon.min_rows_for_table','toon.max_flatten_depth','toon.indent',
'toon.delimiter','toon.strict','toon.key_folding','toon.key_folding_depth','toon.expand_paths',
'toon.omit','toon.omit_keys','toon.key_aliases','toon.date_format','toon.truncate_strings',
'toon.number_precision','one-time-operations.directory','one-time-operations.table','one-time-operations.connection','ide-helper.filename',
...
'boost.browser-logs','brand-voice.extract.index','brand-voice.extract.store','brand-voice.extract.show',
'brand-voice.extract.update','brand-voice.extract.destroy','brand-voice.generate','campaigns.store','auth.login',
'auth.logout','auth.me','spa','storage.local',
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','VIEW_COMPILED_PATH',
'XDEBUG_SESSION','XDEBUG_CONFIG','PULSE_ENABLED','TELESCOPE_ENABLED','NIGHTWATCH_ENABLED',
