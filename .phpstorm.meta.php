...
'boost.executable_paths.vendor_bin','mcp.redirect_domains','one-time-operations.directory','one-time-operations.table','one-time-operations.connection',
...
'boost.browser-logs','spa','storage.local',
...
'REDIS_PORT','REDIS_PREFIX','MAIL_MAILER','MAIL_SCHEME','MAIL_HOST',
...
'VITE_APP_NAME','VIEW_COMPILED_PATH','XDEBUG_SESSION','XDEBUG_CONFIG','PULSE_ENABLED',
'TELESCOPE_ENABLED','NIGHTWATCH_ENABLED','REVERB_APP_ID','REVERB_APP_KEY','REVERB_APP_SECRET',
